...
export const MenuItems: any = [
  ...
  { icon: DashboardIcon, badgetxt: "", title: "Dashboard", type: "sub", active: false, selected: false,
    children: [
      { path: "/dashboard/", type: "link", active: false, selected: false, dirchange: false,  title: "Dashboard"},
    ],
  },
